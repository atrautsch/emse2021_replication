...
from util import BERT, FastTextAutotuned, load_fold_multi_label
...
checkpoint_dir = './checkpoints/{}_{}_{}'.format(model_name, run_number, fold_number)
output_file = './parts/{}_{}_{}.csv'.format(model_name, run_number, fold_number)
batch_size = 8
...
X_train, y_train, X_test, y_test = load_fold_multi_label(run_number, fold_number)
